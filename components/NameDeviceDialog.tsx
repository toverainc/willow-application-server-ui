...
export default function NameDeviceDialog({ client, open, onClose }: { client: Client, open: boolean, onClose: (changed: boolean) => void }) {
    ...
    return (
        <Dialog open={open} onClose={() => onClose(false)}>
            ...
            <DialogContent>
                <TextField sx={{ marginTop: 2 }} value={name} onChange={e => setName(e.target.value)} required label="Device Name" variant="outlined" fullWidth />
            </DialogContent>
            <DialogActions>
