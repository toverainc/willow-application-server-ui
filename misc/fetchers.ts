...
export const BASE_URL = typeof window !== "undefined" && !process.env.NEXT_PUBLIC_WAS_ADDRESS ? window.location.origin : process.env.NEXT_PUBLIC_WAS_ADDRESS;
export const WAS_URL = BASE_URL?.toLowerCase().replace('https://','wss://').replace('http://','ws://') + '/ws';
